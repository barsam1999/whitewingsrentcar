    ...
    <div>
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-blue-950 text-white overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute inset-0" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=1920&h=1080&fit=crop)', backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
        </div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-36">
          <div className="max-w-3xl">
            <div className="flex items-center gap-2 mb-6">
              ...
              <div>
                <h2 className="text-lg font-semibold text-blue-200">White Wings Car Rental</h2>
              </div>
            </div>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Premium Car Rental<br />
              <span className="text-blue-300">in Dubai</span>
            </h1>
            <p className="text-xl text-blue-100 mb-8 leading-relaxed max-w-2xl">
              Experience the finest car rental service in Dubai. From luxury sedans to powerful SUVs, we offer a diverse fleet to match every need and budget. 250 KM included free per day.
            </p>
            <div className="flex flex-wrap gap-4">
              ...
              <Link
                to="/fleet"
                className="border-2 border-white/30 text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-white/10 transition-all backdrop-blur-sm"
              >
                View Our Fleet
              </Link>
              <a
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Featured Rental Cars</h2>
          ...
          <div className="text-center mt-10">
            <Link to="/fleet" className="inline-flex items-center gap-2 text-blue-600 font-semibold hover:text-blue-800 transition-colors text-lg">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Cars for Sale</h2>
            ...
            {carsForSale.slice(0, 4).map((car) => (
              <div key={car.id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-all group">
                ...
                <div className="p-4">
                  ...
                  <p className="text-lg font-bold text-blue-600 mt-2">AED {car.price.toLocaleString()}</p>
                  <Link
                    to={`/cars-for-sale/${car.slug}`}
                    className="mt-3 block text-center text-sm text-blue-600 font-semibold hover:text-blue-800"
                  >
                    View Details →
                  </Link>
                </div>
          ...
          <div className="text-center mt-10">
            <Link to="/cars-for-sale" className="inline-flex items-center gap-2 text-blue-600 font-semibold hover:text-blue-800 transition-colors text-lg">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={idx} className="text-center p-6 rounded-xl bg-gray-50 hover:bg-blue-50 transition-colors group">
      ...
      <section className="py-20 bg-gradient-to-br from-blue-900 to-blue-950 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-blue-200 text-lg max-w-2xl mx-auto">We deliver excellence in every ride</p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">Find Us in Dubai</h2>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  <Phone size={20} className="text-blue-600 mt-1 shrink-0" />
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <Clock size={20} className="text-blue-600 mt-1 shrink-0" />
                  <div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              to="/contact"
              className="bg-white text-blue-700 px-8 py-4 rounded-lg font-bold text-lg hover:bg-blue-50 transition-all shadow-lg"
            >
              Book Now
            </Link>
            <a
